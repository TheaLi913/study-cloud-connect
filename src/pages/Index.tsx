...
import reviewPoster5 from "@/assets/review-poster-5.jpg";
import reviewPoster6 from "@/assets/review-poster-6.jpg";
                ...
                >
                  <div className="overflow-hidden h-[300px] sm:h-[400px] relative">
                    <img 
                      src={poster} 
                      alt={`辅导喜报 ${index + 1}`}
                      className="w-full h-auto object-cover object-top ease-linear group-hover:translate-y-[calc(-100%+300px)] sm:group-hover:translate-y-[calc(-100%+400px)]"
                      style={{ transition: 'transform 30s linear' }}
                    />
                  </div>
